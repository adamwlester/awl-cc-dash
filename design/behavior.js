 ...
 * ========================================================================== */
  ...
  /* Inbox (Plans & Docs card) → review the full plan/doc in Library → Plans or Documents, expanded + flagged.
     Routes by entry kind: a doc-* id opens the Documents tab, any other id opens the Plans tab. */
  function reviewPlan(planId){switchTab('doc',planId.indexOf('doc-')===0?'documents':'plan');const card=document.getElementById(planId);if(!card)return;
