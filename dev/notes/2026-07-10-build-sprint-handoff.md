...
- **Stage-1 adversarial review workflow** (`stage1-adversarial-review`, run wf_f69fb454-c9b): fix any CONFIRMED findings it returns.
...
- **Lane E worktree** (#25 links fixes + #14 identity editing/--name): links single-relationship + piggyback + per-fire exchanges; identity PATCH endpoint + /rename.
