...
- **`dev/notes/TODO.md`** — the Inbox notes driving this work (the ones about Embed/Attach, the Error badge, the feed relabels, Templates→Editor) and the backlog items it closes. See **Docs to keep in sync** at the end.
...
- `dev/notes/TODO.md` **B4** — remove the "*must support the new native ultraplan functionality*" clause.
