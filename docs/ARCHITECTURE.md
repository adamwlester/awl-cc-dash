...
|--------|-------------------|------------|
| §4 | Renderer built + wired + e2e-proven (2026-07-16); the one residual is the #46 rewind anchor (§7.19) | #50 residual (§11.6) |
...
| §7.19 | #46 records carry no rewind anchor (rolled-range marking is client memory, forgotten on reload) | #50 residual (§11.6) |
