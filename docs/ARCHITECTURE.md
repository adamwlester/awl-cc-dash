...
| §4 | The renderer wiring is done; what remains is the pair of phase-3 e2e mechanism drives plus the #46 rewind-anchor residual (§7.19) | phase-3 e2e · #50 residual (§11.6) |
| §7.16 | The `nativeImage` thumbnail IPC awaits its Electron-renderer drive | phase-3 e2e |
