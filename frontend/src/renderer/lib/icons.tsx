...
import {
  ...
  Clipboard, Clock, Copy, CornerDownLeft, CornerUpRight, Cpu, Dices, Download, Eye,
  FileDown, FileText, Folder, FolderGit2, FolderOpen, FolderPlus, Gauge, GitBranch,
  Inbox, Info, Link, Link2, List, ListChecks, Mail, Maximize2, MessageSquare,
...
const MAP: Record<string, LucideIcon> = {
  ...
  'dices': Dices, 'download': Download, 'eye': Eye, 'file-down': FileDown, 'file-text': FileText,
  'folder': Folder, 'folder-git-2': FolderGit2, 'folder-open': FolderOpen, 'folder-plus': FolderPlus,
  'gauge': Gauge, 'git-branch': GitBranch, 'inbox': Inbox, 'info': Info, 'link': Link, 'link-2': Link2,
